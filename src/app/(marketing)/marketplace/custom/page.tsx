    ...
    <div className="min-h-screen bg-[#FAFAF7]">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <nav className="flex items-center gap-2 text-sm text-[#B0ADA6] mb-10">
          ...
          <span>/</span>
          <span className="text-[#2D2B27]">Custom Outcomes</span>
        </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            { icon: Clock, title: 'AI-Accelerated Delivery', description: 'Every engineer on your team ships 2–3x faster than traditional delivery. Our AI Velocity Score measures this — it\'s not marketing, it\'s instrumented.', color: '#6B8F5E' },
            ...
            <div key={benefit.title} className="bg-[#F5F3EE] border border-[#E0DDD6] rounded-xl p-6">
              ...
              <h3 className="font-heading font-semibold text-[#2D2B27] text-base mb-2">{benefit.title}</h3>
              <p className="text-[#8B8781] text-sm leading-relaxed">{benefit.description}</p>
            </div>
          ))}
        </div>
        ...
        {/* How it works */}
        <div className="mb-16">
          <h2 className="font-heading font-bold text-2xl text-[#2D2B27] mb-8">How Custom Engagements Work</h2>
          <div className="space-y-6">
            {PROCESS.map((item, i) => (
              <div key={item.step} className="flex items-start gap-5">
                <div className="w-10 h-10 rounded-full bg-[#6B8F5E] text-white flex items-center justify-center font-mono-brand font-bold text-sm shrink-0">
                  {item.step}
                </div>
                <div className="pb-6 border-b border-[#E0DDD6] flex-1">
                  <h3 className="font-heading font-semibold text-[#2D2B27] text-base mb-1">{item.title}</h3>
        ...
        {/* Example projects */}
        <div className="mb-16">
          <h2 className="font-heading font-bold text-2xl text-[#2D2B27] mb-2">Example Custom Projects</h2>
          <p className="text-[#8B8781] text-sm mb-8">These are representative scopes — every custom engagement is unique.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {EXAMPLES.map((ex) => (
              <div key={ex.title} className="bg-[#FAFAF7] border border-[#E0DDD6] rounded-xl p-6 hover:border-[#FB923C]/30 transition-colors">
                <h3 className="font-heading font-semibold text-[#2D2B27] text-base mb-2">{ex.title}</h3>
                <p className="text-[#8B8781] text-sm leading-relaxed mb-4">{ex.description}</p>
        ...
        {/* CTA */}
        <div className="bg-gradient-to-br from-[#FB923C]/5 via-[#F97316]/5 to-[#D4A574]/5 border border-[#FB923C]/20 rounded-xl p-8 text-center">
          <h3 className="font-heading font-bold text-2xl text-[#2D2B27] mb-3">Ready to discuss your project?</h3>
          <p className="text-[#8B8781] text-sm mb-6 max-w-lg mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#6B8F5E] text-white font-semibold text-sm rounded-lg hover:bg-[#7DA06E] transition-colors"
            >
            ...
            <Link
              href="/signup"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#FAFAF7] text-[#6B8F5E] border border-[#6B8F5E]/30 font-semibold text-sm rounded-lg hover:bg-[#6B8F5E]/5 transition-colors"
            >
              Start onboarding
              <ArrowRight size={13} />
            </Link>
